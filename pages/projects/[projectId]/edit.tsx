...
const getSlackRedirectUrl = (projectId: number) => `https://slack.com/oauth/v2/authorize?scope=incoming-webhook&user_scope=&redirect_uri=https%3A%2F%2Fsimplestat.us%2Fproject%2F${projectId}%2Fedit&client_id=${slackClientId}`;
